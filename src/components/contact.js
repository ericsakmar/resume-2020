...
const getSocialIcon = network => {
  switch (network) {
    case "GitHub":
      return <GitHub className="icon-list-icon" size="1em" />
    case "CodePen":
      return <Codepen className="icon-list-icon" size="1em" />
    case "LinkedIn":
      return <Linkedin className="icon-list-icon" size="1em" />
    default:
      return <div />
  }
}
  ...
  return (
    <ul className="icon-list contact">
      <li className="icon-list-item contact-item">
        <Mail className="icon-list-icon" size="1em" />
        <a href={`mailto:${email}`}>{email}</a>
      </li>

      <li className="icon-list-item contact-item">
        <Phone className="icon-list-icon" size="1em" />
        <a href={`tel:${phone}`}>{phone}</a>
      </li>

      <li className="icon-list-item contact-item">
        <Home className="icon-list-icon" size="1em" />
